...
\section*{2. Dataset recolectado y metodología}

El dataset principal ya fue recolectado mediante la \textit{Mapillary Graph API} en \textbf{tres zonas de estudio por distrito}, usando la misma cuadrícula de 0,005°, límite de 300 imágenes, reintentos y reglas de deduplicación. El release final contiene \textbf{676 imágenes únicas}, \textbf{146 secuencias}, \textbf{12,276 filas de detecciones} y \textbf{129 etiquetas}. Se retuvieron 457 imágenes de San Isidro y 219 de San Juan de Lurigancho. Trabajar con zonas comparables, en vez de descargar los distritos completos, mantiene el alcance realizable y evita que el tamaño desigual de San Juan de Lurigancho domine la comparación.
...
La tabla principal contiene una fila por imagen y una tabla relacionada agrega las detecciones por \texttt{id\_imagen} y categoría. Las categorías se agruparán en: infraestructura peatonal (vereda, cruce cebra, rebaje), regulación vial (señales, semáforos, marcas), soporte urbano (postes e iluminación), movilidad y entorno. Ya se eliminaron IDs duplicados y se validó la geometría contra los límites oficiales; el siguiente paso es normalizar categorías y presentar la cobertura temporal.
...
La adquisición ya fue completada con una cuadrícula simétrica y bitácora reproducible. Jeffry Arturo Hilario Quintana liderará limpieza y trazabilidad; Jeffry Vargas la preparación espacial, comparación y visualización; y Fatima Margarita Villon Zarate la narrativa, experiencia de usuario y evaluación. El mayor riesgo sigue siendo la cobertura desigual de Mapillary y la interpretación excesiva de detecciones automáticas. Se mitigará con tasas por imágenes/tramos, reglas de exclusión explícitas y visualización de cada imagen de origen. La entrega posterior incluirá una interfaz D3 con mapa, filtros por categoría y fecha, comparación entre zonas e inspección de evidencia.
